...
import { encodeHTML } from "./cards/common/utils.js";
...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      cn: `${encodedName} 的 GitCode 统计数据`,
      "zh-tw": `${encodedName} 的 GitCode 統計數據`,
      cs: `GitCode statistiky uživatele ${encodedName}`,
      de: `${encodedName + apostrophe} GitCode-Statistiken`,
      en: `${encodedName}'${apostrophe} GitCode Stats`,
      bn: `${encodedName} এর GitCode পরিসংখ্যান`,
      es: `Estadísticas de GitCode de ${encodedName}`,
      fr: `Statistiques GitCode de ${encodedName}`,
      hu: `${encodedName} GitCode statisztika`,
      it: `Statistiche GitCode di ${encodedName}`,
      ja: `${encodedName}の GitCode 統計`,
      kr: `${encodedName}의 GitCode 통계`,
      nl: `${encodedName}'${apostrophe} GitCode-statistieken`,
      "pt-pt": `Estatísticas do GitCode de ${encodedName}`,
      "pt-br": `Estatísticas do GitCode de ${encodedName}`,
      np: `${encodedName}'${apostrophe} गिटहब तथ्याङ्क`,
      el: `Στατιστικά GitCode του ${encodedName}`,
      ru: `Статистика GitCode пользователя ${encodedName}`,
      "uk-ua": `Статистика GitCode користувача ${encodedName}`,
      id: `Statistik GitCode ${encodedName}`,
      ml: `${encodedName}'${apostrophe} ഗിറ്റ്ഹബ് സ്ഥിതിവിവരക്കണക്കുകൾ`,
      my: `Statistik GitCode ${encodedName}`,
      sk: `GitCode štatistiky používateľa ${encodedName}`,
      tr: `${encodedName} Hesabının GitCode Yıldızları`,
      pl: `Statystyki GitCode użytkownika ${encodedName}`,
      uz: `${encodedName}ning GitCode'dagi statistikasi`,
      vi: `Thống Kê GitCode ${encodedName}`,
      se: `GitCodestatistik för ${encodedName}`,
    },
    "statcard.ranktitle": {
      ar: `${encodedName} إحصائيات غيت هاب`,
      cn: `${encodedName} 的 GitCode 统计数据`,
      ...
      cs: `GitCode statistiky uživatele ${encodedName}`,
      de: `${encodedName + apostrophe} GitCode-Statistiken`,
      en: `${encodedName}'${apostrophe} GitCode Rank`,
      bn: `${encodedName} এর GitCode পরিসংখ্যান`,
      es: `Estadísticas de GitCode de ${encodedName}`,
      fr: `Statistiques GitCode de ${encodedName}`,
      hu: `${encodedName} GitCode statisztika`,
      it: `Statistiche GitCode di ${encodedName}`,
      ja: `${encodedName} の GitCode ランク`,
      kr: `${encodedName}의 GitCode 통계`,
      nl: `${encodedName}'${apostrophe} GitCode-statistieken`,
      "pt-pt": `Estatísticas do GitCode de ${encodedName}`,
      "pt-br": `Estatísticas do GitCode de ${encodedName}`,
